...
export default function Home() {
  ...
  return (
    <div className="">
      <div className="h-full lg:h-[50dvh]  xl:h-[90dvh] mt-[8rem] xl:mt-16 bg-[#eeeeee] mx-4 sm:mx-8 xl:mx-[5.5rem] block lg:flex sm:flex-row flex-col items-center justify-center">
        <div className="text-black flex-1">
          <p className="text-[1.5rem] sm:text-[1.5rem] font-[600] mb-2">
            Silicon Sports Club <br /> presents
          </p>
          <div className="facon leading-normal">
          ...
          <p className="text-[1.25rem] sm:text-[1.5rem] font-[600]">
          ...
          <div className="flex gap-4 items-center text-[1.25rem] sm:text-[1.5rem] mt-6">
            <FaRegCalendarAlt
              className="
            h-6 sm:h-8
            w-6 sm:w-8"
        ...
        <div className="hidden lg:flex w-full h-[20rem] sm:h-full flex-1 items-center justify-center relative">
          ...
          <div className="absolute hidden sm:block sm:w-[12rem] sm:h-[16rem] w-[9rem] h-[13rem] rounded-xl bg-[#d6d6d6] top-[10%] right-[30%] xl:top-[10%] xl:right-[24%] shadow-xl transition-transform duration-300 hover:translate-x-2">
            <Image
              src={
                "https://images.theconversation.com/files/615514/original/file-20240826-20-9ywu2a.jpg?ixlib=rb-4.1.0&rect=156%2C423%2C3560%2C1777&q=45&auto=format&w=668&h=324&fit=crop"
              }
          ...
          <div className="absolute sm:hidden block sm:w-[12rem] sm:h-[16rem] w-[9rem] h-[13rem] rounded-xl bg-[#d6d6d6] top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 shadow-xl transition-transform duration-300 hover:translate-x-2">
            <Image
              src={
                "https://images.theconversation.com/files/615514/original/file-20240826-20-9ywu2a.jpg?ixlib=rb-4.1.0&rect=156%2C423%2C3560%2C1777&q=45&auto=format&w=668&h=324&fit=crop"
              }
          ...
          <div className="absolute sm:w-[12rem] sm:h-[16rem] w-[9rem] h-[13rem] rounded-xl bg-[#d6d6d6] top-[36%%] right-[56%] xl:top-[36%] xl:right-[45%] shadow-xl transition-transform duration-300 hover:translate-x-2">
            <Image
              src={
          ...
          <div className="absolute sm:w-[12rem] sm:h-[16rem] w-[9rem] h-[13rem] rounded-xl bg-[#d6d6d6] top-[24%] right-0 xl:top-[24%] xl:right-[4%] shadow-xl transition-transform duration-300 hover:-translate-x-2">
            <Image
              src={
                "https://www.sportireland.ie/sites/default/files/styles/card/public/2022-12/Lucymull.jpg?h=1a5cb00f&itok=Djcryd8N"
              }
          ...
          <div className="absolute hidden sm:block sm:w-[12rem] sm:h-[16rem] w-[9rem] h-[13rem] rounded-xl bg-[#d6d6d6] top-[53%] right-[9%] xl:top-[53%] xl:right-[11%] shadow-xl transition-transform duration-300 hover:-translate-x-2">
            <Image
              src={
          ...
          <div className="absolute sm:w-[12rem] sm:h-[16rem] w-[9rem] h-[13rem] rounded-xl bg-[#d6d6d6] top-[120%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 sm:hidden block shadow-xl ">
            <Image
              src={
                "https://i2-prod.irishmirror.ie/incoming/article30695458.ece/ALTERNATES/s615/2_inpho_02310494.jpg"
              }
        ...
        <div className="md:hidden flex flex-1 items-center justify-center relative mt-16">
          <Image src={"/assets/hero.svg"} width={500} height={500} alt="hero" />
        </div>
        <div className="hidden lg:hidden md:flex flex-1 items-center justify-center relative mt-16">
          <Image
      ...
      <div className="bg-[#eeeeee] py-8 text-black sm:px-8 xl:px-[5.5rem] items-center justify-center flex flex-col relative">
        ...
        <div className="mt-8 grid grid-col-1 md:grid-cols-3 xl:grid-cols-4 gap-12">
          {events.map((event, index) => {
            return (
              <div
                className="w-[14rem] h-[18rem] rounded-lg shadow-lg relative group cursor-pointer"
                key={index}
              >
                <Image
                  src={event.image}
      ...
      <div className="bg-white sm:px-[5.5rem] flex flex-col items-center sm:py-8 p-4 sm:p-0 relative overflow-hidden text-black justify-center">
      ...
      <div className="bg-[#eeeeee] py-8 text-black p-4  xl:px-[5.5rem] items-center justify-center flex flex-col relative">
        <div className=" bg-white shadow-md w-full  relative">
          ...
          <div className="w-full h-full flex justify-center my-4 pb-4">
            <iframe
      ...
      <div className="bg-blue px-[5.5rem] py-8"></div>
    </div>
  );
}
